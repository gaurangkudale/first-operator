...
type DemovolumeStatus struct {
	...
	// conditions represent the current state of the Demovolume resource.
...
type Demovolume struct {
	...
	// spec defines the desired state of Demovolume
	// +required
	Spec DemovolumeSpec `json:"spec"`

	// status defines the observed state of Demovolume
	// +optional
	Status DemovolumeStatus `json:"status,omitempty,omitzero"`
}
